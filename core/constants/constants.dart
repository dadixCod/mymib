...
class Constants {
  ...
  List<String> topMibTexts = [
    "Nous sommes ravis de proposer une collaboration personnalisée adaptée à vos besoins. Pour en savoir plus sur cette offre, veuillez nous contacter dès que possible. Nous serions heureux de discuter des détails avec vous."
  ];
  List<String> topMibTextsArabic = [
    "نحن سعداء بتقديم تعاون مخصص يتناسب مع احتياجاتكم. لمعرفة المزيد عن هذا العرض، يرجى الاتصال بنا في أقرب وقت ممكن. سنكون سعداء بمناقشة التفاصيل معكم.",
];
  List<String> topMibTextsEnglish = [
    "We are delighted to offer a personalized collaboration tailored to your needs. To learn more about this offer, please contact us as soon as possible. We would be happy to discuss the details with you.",
];
}
